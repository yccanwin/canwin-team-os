...
const negativeCases = [
  ...
  ['ACL repair changed-function inventory reduced', (value) => { value.aclRepairCandidate.expectedChangedFunctions.pop() }],
  ['ACL repair changed-function inventory inflated', (value) => { value.aclRepairCandidate.expectedChangedFunctions.push(value.aclRepairCandidate.expectedChangedFunctions[0]) }],
  ['ACL repair manage-profile writer falsely marked changed', (value) => { value.aclRepairCandidate.expectedChangedFunctions[2] = value.aclRepairCandidate.functions[3].identity }],
  ['ACL repair changed-function inventory reordered', (value) => { value.aclRepairCandidate.expectedChangedFunctions.reverse() }],
