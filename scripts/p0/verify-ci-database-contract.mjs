...
function validate(candidate) {
  ...
  check(JSON.stringify(currentRuntime.contract) === JSON.stringify({ path: 'scripts/p1/isolated-runtime-contract.json', sha256Lf: 'e48ddfe92bdb7db9b63937aa34a3933056c0ba83b59fbaf15bfd5f7722e7a9c9' }) && currentRuntime.contract.sha256Lf === sha256Lf(resolve(repoRoot, currentRuntime.contract.path)), 'ACL repair current runtime contract SHA drift')
  check(JSON.stringify(currentRuntime.runner) === JSON.stringify({ path: 'scripts/p1/run-isolated-runtime.mjs', sha256Lf: 'a4e1325f6593c7c6a2ce15ec15477cf53b8a681a3c218ae757699ff1ed3829c0' }) && currentRuntime.runner.sha256Lf === sha256Lf(resolve(repoRoot, currentRuntime.runner.path)), 'ACL repair current runner SHA drift')
  check(JSON.stringify(currentRuntime.validator) === JSON.stringify({ path: 'scripts/p1/verify-isolated-runtime-runner.mjs', sha256Lf: '99c2fb29440eb9757924f4e840d96652bc6876908e2cab1e1ad6ea93834796dd', assertions: '71/71' }) && currentRuntime.validator.sha256Lf === sha256Lf(resolve(repoRoot, currentRuntime.validator.path)), 'ACL repair current validator SHA or assertion drift')
  ...
  check(atomicCompatibility.status === 'passed' && atomicCompatibility.staticPassed === true && atomicCompatibility.databaseCiPassed === true && atomicCompatibility.remoteQualificationAllowed === true, 'atomic compatibility qualification drift')
  ...
  check(aclCompatibility.status === 'passed' && aclCompatibility.remoteQualificationAllowed === true && JSON.stringify(aclCompatibility.legacyRpcCallSites) === JSON.stringify([]), 'ACL repair application compatibility qualification drift')
  ...
  const priorRepairCi = candidate.priorRepairCiFailureEvidence ?? {}
  check(priorRepairCi.runId === '29726897764' && priorRepairCi.headSha === 'e774ead5a2857afb511400a12897e629033cf941' && priorRepairCi.linuxJobId === '88301987239' && priorRepairCi.windowsJobId === '88301987280', 'prior failed ACL repair CI identity drift')
  check(priorRepairCi.conclusion === 'failure' && priorRepairCi.linuxConclusion === 'failure' && priorRepairCi.windowsConclusion === 'success' && priorRepairCi.sqlTestsStarted === 18 && priorRepairCi.sqlTestsPassed === 17, 'prior failed ACL repair CI result drift')
  check(priorRepairCi.failedAssertionExpectedAuditRows === 6 && priorRepairCi.failedAssertionActualAuditRows === 7 && JSON.stringify(priorRepairCi.correctedExpectedAuditRowsByAction) === JSON.stringify({ memberAccess: 5, supervisorSystem: 1, supervisorScope: 1 }) && priorRepairCi.preservedWithoutRerun === true, 'prior failed ACL repair audit evidence drift')
  const priorSuccessfulRepairCi = candidate.priorSuccessfulRepairCiRunEvidence ?? {}
  check(priorSuccessfulRepairCi.runId === '29733854344' && priorSuccessfulRepairCi.runUrl === 'https://github.com/yccanwin/canwin-team-os/actions/runs/29733854344' && priorSuccessfulRepairCi.headSha === '71b7320b4c303af797ee9e4bf12044518a4fe18a' && priorSuccessfulRepairCi.linuxJobId === '88324427055' && priorSuccessfulRepairCi.windowsJobId === '88324427244', 'historical successful ACL repair CI identity drift')
  check(priorSuccessfulRepairCi.conclusion === 'success' && priorSuccessfulRepairCi.linuxConclusion === 'success' && priorSuccessfulRepairCi.windowsConclusion === 'success' && priorSuccessfulRepairCi.linuxDatabaseAccepted === true, 'historical successful ACL repair CI platform result drift')
  check(priorSuccessfulRepairCi.migrationsPassed === 71 && priorSuccessfulRepairCi.sqlTestsStarted === 27 && priorSuccessfulRepairCi.sqlTestsPassed === 27 && priorSuccessfulRepairCi.databaseTestsPassed === 7 && priorSuccessfulRepairCi.permissionTestsPassed === 11 && priorSuccessfulRepairCi.businessTestsPassed === 9 && priorSuccessfulRepairCi.catalogAssertionsPassed === 4, 'historical successful ACL repair CI database counts drift')
  check(priorSuccessfulRepairCi.windowsStaticGatesExpected === 19 && priorSuccessfulRepairCi.windowsStaticGatesPassed === 19 && priorSuccessfulRepairCi.windowsLocalIntegrationStepsExpected === 12 && priorSuccessfulRepairCi.windowsLocalIntegrationStepsPassed === 12, 'historical successful ACL repair CI Windows counts drift')
  check(priorSuccessfulRepairCi.cleanupPassed === true && priorSuccessfulRepairCi.repositorySecretsRequired === false && priorSuccessfulRepairCi.productionReadPerformed === false && priorSuccessfulRepairCi.productionWritePerformed === false && priorSuccessfulRepairCi.rerunPerformed === false && priorSuccessfulRepairCi.priorFailedRunPreservedWithoutRerun === '29726897764' && priorSuccessfulRepairCi.candidateRemoteExecutionAllowed === false && priorSuccessfulRepairCi.g1OverallClaim === false && priorSuccessfulRepairCi.evidenceScope === 'historical-prior-success-only' && priorSuccessfulRepairCi.currentQualificationAllowed === false, 'historical successful ACL repair CI safety boundary drift')

  const priorFormalAclRepairFailure = candidate.priorFormalAclRepairFailureEvidence ?? {}
  check(priorFormalAclRepairFailure.runId === 'p1-acl-repair-20260720T104323349Z-4fa8de78a8' && priorFormalAclRepairFailure.failureSha256 === '16373794dd745ad86422bb59f3966933532cb0bf073251963b519c2b8e367e73' && priorFormalAclRepairFailure.supervisionHeadSha === '4fa8de78a8b05f8285f69fb0d6d9106e20e3cba7', 'prior formal ACL repair failure identity drift')
  check(priorFormalAclRepairFailure.status === 'failed-stop-preserved' && priorFormalAclRepairFailure.currentStep === 'db-push-dry-run' && priorFormalAclRepairFailure.formalAttemptStarted === false && priorFormalAclRepairFailure.dbPushAttempts === 0 && priorFormalAclRepairFailure.confirmedPersistentWrites === 0 && priorFormalAclRepairFailure.targetPreserved === true && priorFormalAclRepairFailure.successEvidencePresent === false, 'prior formal ACL repair failure preservation drift')

  const formalAclRepairFailure = candidate.formalAclRepairFailureEvidence ?? {}
  check(formalAclRepairFailure.runId === 'p1-acl-repair-20260720T122757275Z-8fa1498850' && formalAclRepairFailure.evidenceDirectory === 'D:/CanWin-Team-OS-4.0-P1-Validation/p1-acl-repair-20260720T122757275Z-8fa1498850' && formalAclRepairFailure.failurePath === 'D:/CanWin-Team-OS-4.0-P1-Validation/p1-acl-repair-20260720T122757275Z-8fa1498850/failure.json', 'formal ACL repair direct-timeout evidence identity drift')
  check(formalAclRepairFailure.failureSha256 === '19e4cd30c3d024a452b74f94380a17175364326dc59d41b837bc338c398579ba' && formalAclRepairFailure.supervisionHeadSha === '8fa14988502511d9722bd37add5b51d845f7934f', 'formal ACL repair direct-timeout evidence SHA or head drift')
  check(formalAclRepairFailure.status === 'failed-stop-preserved' && formalAclRepairFailure.currentStep === 'db-push-dry-run' && formalAclRepairFailure.message === 'signed ACL repair db push dry-run failed: direct isolated database connection timed out before migration enumeration' && formalAclRepairFailure.failureClass === 'isolated-test-direct-database-connection-timeout' && formalAclRepairFailure.connectionMode === 'direct-database-host' && formalAclRepairFailure.migrationVersion === '20260720015435' && formalAclRepairFailure.migrationAlreadyApplied === false, 'formal ACL repair direct-timeout result drift')
  check(JSON.stringify(formalAclRepairFailure.initialMigrationHistory) === JSON.stringify({ lightMigrationRows: 70, fullMigrationRows: 70, exactVersionSetProven: false, claimBoundary: 'row-count-only-not-exact-version-set-proof' }), 'formal ACL repair initial migration evidence drift')
  check(JSON.stringify(formalAclRepairFailure.initialEvidenceCounts) === JSON.stringify({ lightSnapshots: 1, fullReconciliationSnapshots: 1, privateRoutineDefinitionSnapshots: 1, storageArchives: 1 }), 'formal ACL repair initial evidence counts drift')
  check(formalAclRepairFailure.formalAttemptStarted === false && formalAclRepairFailure.verificationStarted === false && formalAclRepairFailure.dbPushAttempted === false && formalAclRepairFailure.dbPushPerformed === false && formalAclRepairFailure.dbPushOutcome === 'not-attempted' && formalAclRepairFailure.dbPushAttempts === 0 && formalAclRepairFailure.attempts === 0, 'formal ACL repair direct-timeout attempt boundary drift')
  check(formalAclRepairFailure.confirmedPersistentWrites === 0 && formalAclRepairFailure.persistentRemoteWrites === 0 && formalAclRepairFailure.persistentRemoteWriteUpperBound === 0 && formalAclRepairFailure.productionReads === 0 && formalAclRepairFailure.productionWrites === 0 && formalAclRepairFailure.secretsPrinted === 0 && formalAclRepairFailure.secretsWritten === 0, 'formal ACL repair direct-timeout write or secret boundary drift')
  check(formalAclRepairFailure.targetPreserved === true && formalAclRepairFailure.retryPerformed === false && formalAclRepairFailure.remoteCleanupPerformed === false && JSON.stringify(formalAclRepairFailure.evidenceInventory) === JSON.stringify({ files: ['failure.json'], fileCount: 1, onlyFailureJson: true }) && formalAclRepairFailure.successEvidencePresent === false, 'formal ACL repair direct-timeout preservation drift')

  const priorParserFixRepairCi = candidate.priorParserFixRepairCiRunEvidence ?? {}
  check(priorParserFixRepairCi.status === 'success' && priorParserFixRepairCi.conclusion === 'success' && priorParserFixRepairCi.runId === '29738966326' && priorParserFixRepairCi.runUrl === 'https://github.com/yccanwin/canwin-team-os/actions/runs/29738966326' && priorParserFixRepairCi.headSha === '070c2e4ca185037d37f65b4d98be617a43e4409d' && priorParserFixRepairCi.linuxJobId === '88340968144' && priorParserFixRepairCi.windowsJobId === '88340968119', 'historical parser-fix ACL repair CI identity drift')
  check(priorParserFixRepairCi.linuxStatus === 'success' && priorParserFixRepairCi.windowsStatus === 'success' && priorParserFixRepairCi.qualificationScope === 'acl_repair_parser_fix_prequalification' && priorParserFixRepairCi.linuxDatabaseAccepted === true && priorParserFixRepairCi.migrationsPassed === 71 && priorParserFixRepairCi.sqlTestsPassed === 27 && priorParserFixRepairCi.catalogAssertionsPassed === 4, 'historical parser-fix ACL repair CI result drift')
  check(priorParserFixRepairCi.windowsStaticGatesPassed === 19 && priorParserFixRepairCi.windowsLocalIntegrationStepsPassed === 12 && priorParserFixRepairCi.productionReadPerformed === false && priorParserFixRepairCi.productionWritePerformed === false && priorParserFixRepairCi.currentQualificationAllowed === false && priorParserFixRepairCi.evidenceScope === 'historical-parser-fix-ci-for-failed-direct-db-candidate' && priorParserFixRepairCi.g1OverallClaim === false, 'historical parser-fix ACL repair CI safety boundary drift')

  const repairCi = candidate.repairCiRunEvidence ?? {}
  check(repairCi.status === 'success' && repairCi.conclusion === 'success' && repairCi.runId === '29750768517' && repairCi.runUrl === 'https://github.com/yccanwin/canwin-team-os/actions/runs/29750768517' && repairCi.headSha === '370a04aa9fddcce9788df33de3f0ae6924bda932' && repairCi.linuxJobId === '88380368836' && repairCi.windowsJobId === '88380368845' && repairCi.linuxStatus === 'success' && repairCi.windowsStatus === 'success', 'current Session Pooler ACL repair CI identity drift')
  check(repairCi.qualificationScope === 'acl_repair_session_pooler_prequalification' && repairCi.requiredConnectionMode === 'session-pooler' && repairCi.newIndependentCiRequired === true && repairCi.newIndependentCi === true && repairCi.evidenceScope === 'current-independent-session-pooler-ci' && repairCi.databaseCiPassed === true && repairCi.remoteQualificationAllowed === true && repairCi.currentQualificationAllowed === true && repairCi.successEvidencePresent === true && repairCi.priorSuccessfulRunPreservedWithoutRerun === '29733854344' && repairCi.priorParserFixRunPreservedWithoutRerun === '29738966326' && repairCi.formalAclRepairFailurePreservedWithoutRerun === 'p1-acl-repair-20260720T122757275Z-8fa1498850' && repairCi.productionReadPerformed === false && repairCi.productionWritePerformed === false && repairCi.priorQualifiedRunId === '29738966326' && repairCi.closedByFormalAclRepairFailureRunId === 'p1-acl-repair-20260720T122757275Z-8fa1498850' && repairCi.g1OverallClaim === false, 'current Session Pooler ACL repair CI qualification drift')

  const attempts = candidate.formalAttemptHistory ?? []
  check(attempts.length === 28, 'formal attempt history count drift')
  ...
  const aclRepairSuccessAttempt = attempts[25] ?? {}
  check(JSON.stringify(aclRepairSuccessAttempt) === JSON.stringify({ runId: '29733854344', runUrl: 'https://github.com/yccanwin/canwin-team-os/actions/runs/29733854344', jobId: '88324427055', windowsJobId: '88324427244', headSha: '71b7320b4c303af797ee9e4bf12044518a4fe18a', conclusion: 'success', qualificationScope: 'acl_repair_prequalification', windowsLocalGatePassed: true, windowsStaticGatesExpected: 19, windowsStaticGatesPassed: 19, windowsLocalIntegrationStepsExpected: 12, windowsLocalIntegrationStepsPassed: 12, databaseStartupPassed: true, baselinePassed: true, linuxDatabaseAccepted: true, migrationsPassed: 71, sqlTestsStarted: 27, sqlTestsPassed: 27, databaseTestsPassed: 7, permissionTestsPassed: 11, businessTestsPassed: 9, catalogAssertionsPassed: 4, successMarker: 'P0_CI_DATABASE_GATES_OK', cleanupPassed: true, repositorySecretsRequired: false, testProjectRemoteReads: 0, testProjectRemoteWrites: 0, productionReadPerformed: false, productionWritePerformed: false, rerunOfFailedRun: false, priorFailedRunsPreservedWithoutRerun: ['29726897764'], isolatedTestProjectPersistentApplyPassed: false, reconciliationPassed: false, pageAccountAcceptancePassed: false, g1OverallClaim: false }), 'latest ACL repair success CI attempt drift')
  const aclRepairParserFixSuccessAttempt = attempts[26] ?? {}
  check(aclRepairParserFixSuccessAttempt.runId === '29738966326' && aclRepairParserFixSuccessAttempt.runUrl === 'https://github.com/yccanwin/canwin-team-os/actions/runs/29738966326' && aclRepairParserFixSuccessAttempt.jobId === '88340968144' && aclRepairParserFixSuccessAttempt.windowsJobId === '88340968119' && aclRepairParserFixSuccessAttempt.headSha === '070c2e4ca185037d37f65b4d98be617a43e4409d' && aclRepairParserFixSuccessAttempt.conclusion === 'success', 'latest ACL repair parser-fix CI attempt identity drift')
  check(aclRepairParserFixSuccessAttempt.qualificationScope === 'acl_repair_parser_fix_prequalification' && aclRepairParserFixSuccessAttempt.windowsLocalGatePassed === true && aclRepairParserFixSuccessAttempt.windowsStaticGatesExpected === 19 && aclRepairParserFixSuccessAttempt.windowsStaticGatesPassed === 19 && aclRepairParserFixSuccessAttempt.windowsLocalIntegrationStepsExpected === 12 && aclRepairParserFixSuccessAttempt.windowsLocalIntegrationStepsPassed === 12, 'latest ACL repair parser-fix CI Windows result drift')
  check(aclRepairParserFixSuccessAttempt.databaseStartupPassed === true && aclRepairParserFixSuccessAttempt.baselinePassed === true && aclRepairParserFixSuccessAttempt.linuxDatabaseAccepted === true && aclRepairParserFixSuccessAttempt.migrationsPassed === 71 && aclRepairParserFixSuccessAttempt.sqlTestsStarted === 27 && aclRepairParserFixSuccessAttempt.sqlTestsPassed === 27 && aclRepairParserFixSuccessAttempt.databaseTestsPassed === 7 && aclRepairParserFixSuccessAttempt.permissionTestsPassed === 11 && aclRepairParserFixSuccessAttempt.businessTestsPassed === 9 && aclRepairParserFixSuccessAttempt.catalogAssertionsPassed === 4 && aclRepairParserFixSuccessAttempt.successMarker === 'P0_CI_DATABASE_GATES_OK', 'latest ACL repair parser-fix CI database result drift')
  check(aclRepairParserFixSuccessAttempt.cleanupPassed === true && aclRepairParserFixSuccessAttempt.repositorySecretsRequired === false && aclRepairParserFixSuccessAttempt.repositorySecretsUsed === 0 && aclRepairParserFixSuccessAttempt.testProjectRemoteReads === 0 && aclRepairParserFixSuccessAttempt.testProjectRemoteWrites === 0 && aclRepairParserFixSuccessAttempt.productionReadPerformed === false && aclRepairParserFixSuccessAttempt.productionWritePerformed === false && aclRepairParserFixSuccessAttempt.rerunOfFailedRun === false, 'latest ACL repair parser-fix CI safety boundary drift')
  check(JSON.stringify(aclRepairParserFixSuccessAttempt.priorFailedRunsPreservedWithoutRerun) === JSON.stringify(['29726897764']) && aclRepairParserFixSuccessAttempt.priorSuccessfulRunPreservedWithoutRerun === '29733854344' && aclRepairParserFixSuccessAttempt.formalAclRepairFailurePreservedWithoutRerun === 'p1-acl-repair-20260720T104323349Z-4fa8de78a8' && aclRepairParserFixSuccessAttempt.isolatedTestProjectPersistentApplyPassed === false && aclRepairParserFixSuccessAttempt.reconciliationPassed === false && aclRepairParserFixSuccessAttempt.pageAccountAcceptancePassed === false && aclRepairParserFixSuccessAttempt.g1OverallClaim === false, 'latest ACL repair parser-fix CI qualification boundary drift')
  const aclRepairSessionPoolerAttempt = attempts[27] ?? {}
  check(aclRepairSessionPoolerAttempt.runId === '29750768517' && aclRepairSessionPoolerAttempt.runUrl === 'https://github.com/yccanwin/canwin-team-os/actions/runs/29750768517' && aclRepairSessionPoolerAttempt.jobId === '88380368836' && aclRepairSessionPoolerAttempt.windowsJobId === '88380368845' && aclRepairSessionPoolerAttempt.headSha === '370a04aa9fddcce9788df33de3f0ae6924bda932' && aclRepairSessionPoolerAttempt.conclusion === 'success', 'latest Session Pooler CI attempt identity drift')
  check(aclRepairSessionPoolerAttempt.qualificationScope === 'acl_repair_session_pooler_prequalification' && aclRepairSessionPoolerAttempt.requiredConnectionMode === 'session-pooler' && aclRepairSessionPoolerAttempt.newIndependentCi === true && aclRepairSessionPoolerAttempt.migrationsPassed === 71 && aclRepairSessionPoolerAttempt.sqlTestsPassed === 27 && aclRepairSessionPoolerAttempt.databaseTestsPassed === 7 && aclRepairSessionPoolerAttempt.permissionTestsPassed === 11 && aclRepairSessionPoolerAttempt.businessTestsPassed === 9 && aclRepairSessionPoolerAttempt.catalogAssertionsPassed === 4, 'latest Session Pooler CI result drift')
  check(aclRepairSessionPoolerAttempt.productionReadPerformed === false && aclRepairSessionPoolerAttempt.productionWritePerformed === false && aclRepairSessionPoolerAttempt.candidateRemoteExecutionAllowed === false && aclRepairSessionPoolerAttempt.isolatedTestProjectPersistentApplyPassed === false && aclRepairSessionPoolerAttempt.reconciliationPassed === false && aclRepairSessionPoolerAttempt.pageAccountAcceptancePassed === false && aclRepairSessionPoolerAttempt.g1OverallClaim === false, 'latest Session Pooler CI acceptance boundary drift')
...
const negativeCases = [
  ...
  ['atomic database CI acceptance erased', (value) => { value.aclRepairCandidate.atomicLegacyRoleCompatibility.databaseCiPassed = false }],
  ...
  ['historical successful ACL repair CI erased', (value) => { value.priorSuccessfulRepairCiRunEvidence.conclusion = 'failure' }],
  ['historical successful ACL repair CI evidence removed', (value) => { delete value.priorSuccessfulRepairCiRunEvidence }],
  ['current ACL repair CI success erased', (value) => { value.repairCiRunEvidence.conclusion = 'failure' }],
  ['current signed ACL repair CI reuses historical run', (value) => { value.aclRepairCandidate.signedCiRunId = '29733854344'; value.aclRepairCandidate.signedCiHeadSha = '71b7320b4c303af797ee9e4bf12044518a4fe18a' }],
  ['formal ACL repair failure SHA tampered', (value) => { value.formalAclRepairFailureEvidence.failureSha256 = '0'.repeat(64) }],
  ['formal ACL repair failure step erased', (value) => { value.formalAclRepairFailureEvidence.currentStep = null; value.formalAclRepairFailureEvidence.message = null }],
  ['formal ACL repair attempt falsely started', (value) => { value.formalAclRepairFailureEvidence.formalAttemptStarted = true }],
  ['formal ACL repair db push falsely attempted', (value) => { value.formalAclRepairFailureEvidence.dbPushAttempts = 1 }],
  ['formal ACL repair persistent write falsely claimed', (value) => { value.formalAclRepairFailureEvidence.persistentRemoteWrites = 1 }],
  ['formal ACL repair success evidence falsely present', (value) => { value.formalAclRepairFailureEvidence.successEvidencePresent = true }],
  ['formal ACL repair failure inventory expanded', (value) => { value.formalAclRepairFailureEvidence.evidenceInventory.files.push('success.json'); value.formalAclRepairFailureEvidence.evidenceInventory.fileCount = 2; value.formalAclRepairFailureEvidence.evidenceInventory.onlyFailureJson = false }],
  ['formal ACL repair target preservation erased', (value) => { value.formalAclRepairFailureEvidence.targetPreserved = false }],
