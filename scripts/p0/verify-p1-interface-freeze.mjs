...
function validate(candidate) {
  ...
  check(JSON.stringify(currentRuntime.contract) === JSON.stringify({ path: 'scripts/p1/isolated-runtime-contract.json', sha256Lf: '4b7db4155637bc349c50948eaa35f2d241e823b3e65c0578e3be083e93344659' }) && currentRuntime.contract.sha256Lf === sha256Utf8Lf(readFileSync(resolve(repoRoot, currentRuntime.contract.path), 'utf8')), 'ACL repair current runtime contract SHA drift')
  check(JSON.stringify(currentRuntime.runner) === JSON.stringify({ path: 'scripts/p1/run-isolated-runtime.mjs', sha256Lf: 'acae6010b6e4efca94d8411b16aa2cf8e1e04118ecf9055a9711ebb55eb3d2bc' }) && currentRuntime.runner.sha256Lf === sha256Utf8Lf(readFileSync(resolve(repoRoot, currentRuntime.runner.path), 'utf8')), 'ACL repair current runner SHA drift')
  check(JSON.stringify(currentRuntime.validator) === JSON.stringify({ path: 'scripts/p1/verify-isolated-runtime-runner.mjs', sha256Lf: '1aa9341425465a42ae7cd82d434281595723b00733fafc17be3176f73ee5d5f4', assertions: '63/63' }) && currentRuntime.validator.sha256Lf === sha256Utf8Lf(readFileSync(resolve(repoRoot, currentRuntime.validator.path), 'utf8')), 'ACL repair current validator SHA or assertion drift')
  ...
  check(aclRepairCi.runId === '29733854344' && aclRepairCi.runUrl === 'https://github.com/yccanwin/canwin-team-os/actions/runs/29733854344' && aclRepairCi.headSha === '71b7320b4c303af797ee9e4bf12044518a4fe18a' && aclRepairCi.linuxJobId === '88324427055' && aclRepairCi.windowsJobId === '88324427244', 'successful ACL repair CI identity drift')
  check(aclRepairCi.conclusion === 'success' && aclRepairCi.linuxConclusion === 'success' && aclRepairCi.windowsConclusion === 'success' && aclRepairCi.linuxDatabaseAccepted === true, 'successful ACL repair CI platform result drift')
  check(aclRepairCi.migrationsPassed === 71 && aclRepairCi.sqlTestsStarted === 27 && aclRepairCi.sqlTestsPassed === 27 && aclRepairCi.databaseTestsPassed === 7 && aclRepairCi.permissionTestsPassed === 11 && aclRepairCi.businessTestsPassed === 9 && aclRepairCi.catalogAssertionsPassed === 4, 'successful ACL repair CI database counts drift')
  check(aclRepairCi.windowsStaticGatesExpected === 19 && aclRepairCi.windowsStaticGatesPassed === 19 && aclRepairCi.windowsLocalIntegrationStepsExpected === 12 && aclRepairCi.windowsLocalIntegrationStepsPassed === 12, 'successful ACL repair CI Windows counts drift')
  check(aclRepairCi.cleanupPassed === true && aclRepairCi.repositorySecretsRequired === false && aclRepairCi.productionReadPerformed === false && aclRepairCi.productionWritePerformed === false && aclRepairCi.rerunPerformed === false && aclRepairCi.priorFailedRunPreservedWithoutRerun === '29726897764' && aclRepairCi.candidateRemoteExecutionAllowed === false && aclRepairCi.g1OverallClaim === false, 'successful ACL repair CI safety boundary drift')
