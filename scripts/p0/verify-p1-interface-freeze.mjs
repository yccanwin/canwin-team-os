...
function validate(candidate) {
  ...
  check(aclRepairCi.status === 'success' && aclRepairCi.conclusion === 'success' && aclRepairCi.runId === '29738966326' && aclRepairCi.runUrl === 'https://github.com/yccanwin/canwin-team-os/actions/runs/29738966326' && aclRepairCi.headSha === '070c2e4ca185037d37f65b4d98be617a43e4409d' && aclRepairCi.linuxJobId === '88340968144' && aclRepairCi.windowsJobId === '88340968119', 'current ACL repair parser-fix CI identity drift')
  check(aclRepairCi.linuxStatus === 'success' && aclRepairCi.windowsStatus === 'success' && aclRepairCi.qualificationScope === 'acl_repair_parser_fix_prequalification' && aclRepairCi.linuxDatabaseAccepted === true, 'current ACL repair parser-fix CI platform result drift')
  check(aclRepairCi.migrationsPassed === 71 && aclRepairCi.sqlTestsStarted === 27 && aclRepairCi.sqlTestsPassed === 27 && aclRepairCi.databaseTestsPassed === 7 && aclRepairCi.permissionTestsPassed === 11 && aclRepairCi.businessTestsPassed === 9 && aclRepairCi.catalogAssertionsPassed === 4, 'current ACL repair parser-fix CI database counts drift')
  check(aclRepairCi.windowsStaticExpected === 19 && aclRepairCi.windowsStaticPassed === 19 && aclRepairCi.windowsStaticGatesExpected === 19 && aclRepairCi.windowsStaticGatesPassed === 19 && aclRepairCi.windowsLocalExpected === 12 && aclRepairCi.windowsLocalPassed === 12 && aclRepairCi.windowsLocalIntegrationStepsExpected === 12 && aclRepairCi.windowsLocalIntegrationStepsPassed === 12, 'current ACL repair parser-fix CI Windows counts drift')
  check(aclRepairCi.cleanupPassed === true && aclRepairCi.repositorySecretsRequired === false && aclRepairCi.repositorySecretsUsed === 0 && aclRepairCi.testProjectRemoteReads === 0 && aclRepairCi.testProjectRemoteWrites === 0 && aclRepairCi.productionReadPerformed === false && aclRepairCi.productionWritePerformed === false && aclRepairCi.retryPerformed === false, 'current ACL repair parser-fix CI safety evidence drift')
  check(aclRepairCi.priorFailedRunPreservedWithoutRerun === '29726897764' && aclRepairCi.priorSuccessfulRunPreservedWithoutRerun === '29733854344' && aclRepairCi.formalAclRepairFailurePreservedWithoutRerun === 'p1-acl-repair-20260720T104323349Z-4fa8de78a8' && aclRepairCi.candidateRemoteExecutionAllowed === false, 'current ACL repair parser-fix history preservation drift')
  check(aclRepairCi.databaseCiPassed === true && aclRepairCi.remoteQualificationAllowed === true && aclRepairCi.currentQualificationAllowed === true && aclRepairCi.successEvidencePresent === true && aclRepairCi.g1OverallClaim === false, 'current ACL repair parser-fix qualification drift')
