...
const mapOrder = (row: AnyRow): RealOrderDelivery => {
  ...
  return {
    ...
    installedAt: implementation?.installed_at ? String(implementation.installed_at) : null, trainedAt: implementation?.trained_at ? String(implementation.trained_at) : null,
