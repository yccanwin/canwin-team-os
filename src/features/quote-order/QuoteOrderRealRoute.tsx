...
export default function QuoteOrderRealRoute() {
  ...
  return <section className="min-h-screen bg-slate-50 p-3 pb-8 sm:p-6"><header className="mb-5"><a href="#/sales-v3" className="mb-3 inline-flex rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm text-indigo-700">← 返回销售工作台</a><p className="text-sm font-medium text-indigo-600">真实数据入口</p><h1 className="text-2xl font-bold text-slate-900">报价与定金工作台</h1><p className="mt-1 text-sm text-slate-500">报价写入仅通过服务端安全 RPC；内部结算价由目录采购成本自动生成。</p></header>
