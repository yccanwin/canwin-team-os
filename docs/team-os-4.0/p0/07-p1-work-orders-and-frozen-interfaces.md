...
> 状态：P1 工单和接口已冻结；历史失败运行均原样保留且未重跑。资格签名 CI run `29699951990`（HEAD `a620bb541f4c5eb613413e8b40455b3988ee0cf3`）已双平台全绿：Linux job `88227205377` 为70/27/7/11/9/4，Windows job `88227205362` 为static19/19、local12/12。续验候选冻结为 exact70、27项逐项、29份完整快照、2次 Storage 内容复核和6份签名制品，夹具模式4/4、runner validator 100/100。旧应用入口永久关闭；只开放已应用后的 resume-only 续验资格，签名HEAD本身和tracked dirty工作区均拒绝，未跟踪的 `.codex-audit` 证据允许保留。续验尚未执行，开始时仍须证明当前 exact70；全量对账和六类账号页面验收仍待完成。当前 `candidateRemote=false`、`resumeRemote=true`、`resumeSigned=a620bb...`、G1=false，整体验收仍为25%。
