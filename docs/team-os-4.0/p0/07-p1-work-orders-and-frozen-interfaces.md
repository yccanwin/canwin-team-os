...
> 状态：P1 工单和接口已冻结；历史失败运行和历史exact70续验资格均原样保留。ACL/原子候选 CI run [`29726897764`](https://github.com/yccanwin/canwin-team-os/actions/runs/29726897764) 已首错停止且未重跑；修正候选 run [`29733854344`](https://github.com/yccanwin/canwin-team-os/actions/runs/29733854344) 已通过 Linux 迁移71/71、SQL27/27、catalog4/4及 Windows static19/19、local12/12。其后正式命令 `p1-acl-repair-20260720T104323349Z-4fa8de78a8` 在 `db-push-dry-run` 首错停止，正式/db push尝试0、持久写0、生产读写0；旧资格已关闭，新候选已通过本地 static19/19、local12/12，待新CI。G1=false，整体验收仍为25%。
