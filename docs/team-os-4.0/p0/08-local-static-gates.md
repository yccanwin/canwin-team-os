...
- CI 数据库边界自检：合同 definitions=54、redefined=28、directOrderFixtures=2、negative=28/28，runner negative=6/6、databaseCalls=0；
